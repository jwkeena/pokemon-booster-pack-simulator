...
function newPackAquapolis() {
    ...
    increaseCounter();
    checkFlip = 1;
    document.getElementById("set1").src = "aquapolis-pokemon-set-symbol.png";
    ...
    changePackArt2();
    if (packArt2 === 1) {
        document.getElementById("boosterPackFront1").src="aquapolis1.jpg";
        document.getElementById("boosterPackBack1").src="aquapolisback.jpg";
    }
    if (packArt2 === 2) {
        document.getElementById("boosterPackFront1").src="aquapolis2.jpg";
        document.getElementById("boosterPackBack1").src="aquapolisback.jpg";
    }
    if (packArt2 === 3) {
        document.getElementById("boosterPackFront1").src="aquapolis3.jpg";
        document.getElementById("boosterPackBack1").src="aquapolisback.jpg";
    }
    if (packArt2 === 4) {
        document.getElementById("boosterPackFront1").src="aquapolis4.jpg";
        document.getElementById("boosterPackBack1").src="aquapolisback.jpg";
    }
    //Picks 5 commons. I pick them before the reverse holo since the reverse holo CAN be a duplicate
    //of a card already pulled.
...
function newPackSkyridge() {
    ...
    increaseCounter();
    checkFlip = 1;
    document.getElementById("set1").src = "skyridge-pokemon-set-symbol.png";
    ...
    changePackArt2();
    if (packArt2 === 1) {
        document.getElementById("boosterPackFront1").src="skyridge1.jpg";
        document.getElementById("boosterPackBack1").src="skyridgeback.jpg";
    }
    if (packArt2 === 2) {
        document.getElementById("boosterPackFront1").src="skyridge2.jpg";
        document.getElementById("boosterPackBack1").src="skyridgeback.jpg";
    }
    if (packArt2 === 1) {
        document.getElementById("boosterPackFront1").src="skyridge3.jpg";
        document.getElementById("boosterPackBack1").src="skyridgeback.jpg";
    }
    if (packArt2 === 4) {
        document.getElementById("boosterPackFront1").src="skyridge4.jpg";
        document.getElementById("boosterPackBack1").src="skyridgeback.jpg";
    }
